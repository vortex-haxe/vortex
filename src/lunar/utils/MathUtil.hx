...
import lunar.math.Rectangle;

/**
 * A class containing useful math utilities
 * not found in Haxe itself.
 * 
 * A very large chunk of them were taken from HaxeFlixel, go check it out!
...
class MathUtil {
	 ...
	 */
	public static function truncate(Value:Float, Precision:Int):Float {
		final mult:Float = 10 ^ Precision;
